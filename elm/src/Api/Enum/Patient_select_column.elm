...
module Api.Enum.Patient_select_column exposing (..)
        ...
        |> Decode.andThen
            (\string ->
                case string of
                    ...
                    _ ->
                        Decode.fail ("Invalid Patient_select_column type, " ++ string ++ " try re-running the @dillonkearns/elm-graphql CLI ")
            )


{-| Convert from the union type representating the Enum to a string that the GraphQL server will recognize.
-}
toString : Patient_select_column -> String
toString enum =
    case enum of
        Code_postal ->
            "code_postal"
...
-}
fromString : String -> Maybe Patient_select_column
