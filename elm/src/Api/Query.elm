...
-}
agenda : (AgendaOptionalArguments -> AgendaOptionalArguments) -> SelectionSet decodesTo Api.Object.Agenda -> SelectionSet (List decodesTo) RootQuery
...
-}
agenda_by_pk : AgendaByPkRequiredArguments -> SelectionSet decodesTo Api.Object.Agenda -> SelectionSet (Maybe decodesTo) RootQuery
...
-}
consultation : (ConsultationOptionalArguments -> ConsultationOptionalArguments) -> SelectionSet decodesTo Api.Object.Consultation -> SelectionSet (List decodesTo) RootQuery
...
-}
consultation_by_pk : ConsultationByPkRequiredArguments -> SelectionSet decodesTo Api.Object.Consultation -> SelectionSet (Maybe decodesTo) RootQuery
...
-}
patient : (PatientOptionalArguments -> PatientOptionalArguments) -> SelectionSet decodesTo Api.Object.Patient -> SelectionSet (List decodesTo) RootQuery
...
-}
patient_Profession : (PatientProfessionOptionalArguments -> PatientProfessionOptionalArguments) -> SelectionSet decodesTo Api.Object.Patient_Profession -> SelectionSet (List decodesTo) RootQuery
...
-}
patient_Profession_by_pk : PatientProfessionByPkRequiredArguments -> SelectionSet decodesTo Api.Object.Patient_Profession -> SelectionSet (Maybe decodesTo) RootQuery
...
-}
patient_by_pk : PatientByPkRequiredArguments -> SelectionSet decodesTo Api.Object.Patient -> SelectionSet (Maybe decodesTo) RootQuery
...
-}
profession : (ProfessionOptionalArguments -> ProfessionOptionalArguments) -> SelectionSet decodesTo Api.Object.Profession -> SelectionSet (List decodesTo) RootQuery
...
-}
profession_by_pk : ProfessionByPkRequiredArguments -> SelectionSet decodesTo Api.Object.Profession -> SelectionSet (Maybe decodesTo) RootQuery
