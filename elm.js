...
var $author$project$Api$Cred = function (a) {
	return {$: 'Cred', a: a};
};
...
var $author$project$Api$application = function (config) {
	var init = F3(
		function (flags, url, navKey) {
			var maybeCred = $elm$core$Result$toMaybe(
				A2(
					$elm$core$Result$andThen,
					$elm$json$Json$Decode$decodeString($author$project$Api$credDecoder),
					A2($elm$json$Json$Decode$decodeValue, $elm$json$Json$Decode$string, flags)));
			return A3(config.init, maybeCred, url, navKey);
		});
...
var $author$project$Main$Calendar = function (a) {
	return {$: 'Calendar', a: a};
};
...
var $author$project$Main$GotPatientsMsg = function (a) {
	return {$: 'GotPatientsMsg', a: a};
};
...
var $author$project$Api$Scalar$Money = function (a) {
	return {$: 'Money', a: a};
};
var $author$project$Api$Scalar$Smallint = function (a) {
	return {$: 'Smallint', a: a};
};
var $author$project$Api$Scalar$Timetz = function (a) {
	return {$: 'Timetz', a: a};
};
...
var $author$project$Api$Scalar$defaultCodecs = {
	...
	codecMoney: {
		decoder: A2($elm$json$Json$Decode$map, $author$project$Api$Scalar$Money, $dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$scalarDecoder),
	...
	codecSmallint: {
		decoder: A2($elm$json$Json$Decode$map, $author$project$Api$Scalar$Smallint, $dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$scalarDecoder),
	...
	codecTimetz: {
		decoder: A2($elm$json$Json$Decode$map, $author$project$Api$Scalar$Timetz, $dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$scalarDecoder),
		encoder: function (_v4) {
			var raw = _v4.a;
			return $elm$json$Json$Encode$string(raw);
		}
	}
...
var $author$project$Api$InputObject$encodeDate_comparison_exp = function (input) {
...
var $author$project$Api$InputObject$encodeInt_comparison_exp = function (input) {
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'_eq',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.eq_, $dillonkearns$elm_graphql$Graphql$Internal$Encode$int)),
				_Utils_Tuple2(
				'_gt',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.gt_, $dillonkearns$elm_graphql$Graphql$Internal$Encode$int)),
				_Utils_Tuple2(
				'_gte',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.gte_, $dillonkearns$elm_graphql$Graphql$Internal$Encode$int)),
				_Utils_Tuple2(
				'_in',
				A2(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$optional,
				...
				_Utils_Tuple2(
				'_lt',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.lt_, $dillonkearns$elm_graphql$Graphql$Internal$Encode$int)),
				_Utils_Tuple2(
				'_lte',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.lte_, $dillonkearns$elm_graphql$Graphql$Internal$Encode$int)),
				_Utils_Tuple2(
				'_neq',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.neq_, $dillonkearns$elm_graphql$Graphql$Internal$Encode$int)),
				_Utils_Tuple2(
				'_nin',
				A2(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$optional,
...
var $author$project$Api$InputObject$encodeMoney_comparison_exp = function (input) {
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var $author$project$Api$InputObject$encodeSmallint_comparison_exp = function (input) {
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var $author$project$Api$InputObject$encodeString_comparison_exp = function (input) {
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var $author$project$Api$InputObject$encodeTimetz_comparison_exp = function (input) {
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var $author$project$Api$InputObject$encodeAgenda_bool_exp = function (_v4) {
	var input = _v4.a;
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'Consultations',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.consultations, $author$project$Api$InputObject$encodeConsultation_bool_exp)),
				_Utils_Tuple2(
				'_and',
				A2(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$optional,
					input.and_,
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$list(
						$dillonkearns$elm_graphql$Graphql$Internal$Encode$maybe($author$project$Api$InputObject$encodeAgenda_bool_exp)))),
				_Utils_Tuple2(
				'_not',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.not_, $author$project$Api$InputObject$encodeAgenda_bool_exp)),
				_Utils_Tuple2(
				'_or',
				A2(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$optional,
				...
				_Utils_Tuple2(
				'date',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.date, $author$project$Api$InputObject$encodeDate_comparison_exp)),
				_Utils_Tuple2(
				'heure',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.heure, $author$project$Api$InputObject$encodeTimetz_comparison_exp)),
				_Utils_Tuple2(
				'id_agenda',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.id_agenda, $author$project$Api$InputObject$encodeInt_comparison_exp))
			]));
};
var $author$project$Api$InputObject$encodeConsultation_bool_exp = function (_v3) {
	var input = _v3.a;
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'Agenda',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.agenda, $author$project$Api$InputObject$encodeAgenda_bool_exp)),
				_Utils_Tuple2(
				'Patient',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.patient, $author$project$Api$InputObject$encodePatient_bool_exp)),
				_Utils_Tuple2(
				'_and',
				A2(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$optional,
					input.and_,
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$list(
						$dillonkearns$elm_graphql$Graphql$Internal$Encode$maybe($author$project$Api$InputObject$encodeConsultation_bool_exp)))),
				_Utils_Tuple2(
				'_not',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.not_, $author$project$Api$InputObject$encodeConsultation_bool_exp)),
				_Utils_Tuple2(
				'_or',
				A2(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$optional,
				...
				_Utils_Tuple2(
				'id_patient',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.id_patient, $author$project$Api$InputObject$encodeInt_comparison_exp)),
				_Utils_Tuple2(
				'indice_anxiete',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.indice_anxiete, $author$project$Api$InputObject$encodeSmallint_comparison_exp)),
				_Utils_Tuple2(
				'mode_de_reglement',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.mode_de_reglement, $author$project$Api$InputObject$encodeString_comparison_exp)),
				_Utils_Tuple2(
				'mots_cles',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.mots_cles, $author$project$Api$InputObject$encodeString_comparison_exp)),
				_Utils_Tuple2(
				'prix',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.prix, $author$project$Api$InputObject$encodeMoney_comparison_exp))
			]));
};
var $author$project$Api$InputObject$encodePatient_Profession_bool_exp = function (_v2) {
	var input = _v2.a;
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'Profession',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.profession, $author$project$Api$InputObject$encodeProfession_bool_exp)),
				_Utils_Tuple2(
				'_and',
				A2(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$optional,
					input.and_,
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$list(
						$dillonkearns$elm_graphql$Graphql$Internal$Encode$maybe($author$project$Api$InputObject$encodePatient_Profession_bool_exp)))),
				_Utils_Tuple2(
				'_not',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.not_, $author$project$Api$InputObject$encodePatient_Profession_bool_exp)),
				_Utils_Tuple2(
				'_or',
				A2(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$optional,
				...
				_Utils_Tuple2(
				'date_de_debut',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.date_de_debut, $author$project$Api$InputObject$encodeDate_comparison_exp)),
				_Utils_Tuple2(
				'date_de_fin',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.date_de_fin, $author$project$Api$InputObject$encodeDate_comparison_exp)),
				_Utils_Tuple2(
				'id_patient',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.id_patient, $author$project$Api$InputObject$encodeInt_comparison_exp)),
				_Utils_Tuple2(
				'id_profession',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.id_profession, $author$project$Api$InputObject$encodeInt_comparison_exp))
			]));
};
var $author$project$Api$InputObject$encodePatient_bool_exp = function (_v1) {
	var input = _v1.a;
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'Patient_Professions',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.patient_Professions, $author$project$Api$InputObject$encodePatient_Profession_bool_exp)),
				_Utils_Tuple2(
				'_and',
				A2(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$optional,
					input.and_,
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$list(
						$dillonkearns$elm_graphql$Graphql$Internal$Encode$maybe($author$project$Api$InputObject$encodePatient_bool_exp)))),
				_Utils_Tuple2(
				'_not',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.not_, $author$project$Api$InputObject$encodePatient_bool_exp)),
				_Utils_Tuple2(
				'_or',
				A2(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$optional,
				...
				_Utils_Tuple2(
				'code_postal',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.code_postal, $author$project$Api$InputObject$encodeInt_comparison_exp)),
				_Utils_Tuple2(
				'date_de_naissance',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.date_de_naissance, $author$project$Api$InputObject$encodeDate_comparison_exp)),
				_Utils_Tuple2(
				'genre',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.genre, $author$project$Api$InputObject$encodeString_comparison_exp)),
				_Utils_Tuple2(
				'id_patient',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.id_patient, $author$project$Api$InputObject$encodeInt_comparison_exp)),
				_Utils_Tuple2(
				'moyen_de_decouverte',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.moyen_de_decouverte, $author$project$Api$InputObject$encodeString_comparison_exp)),
				_Utils_Tuple2(
				'nom',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.nom, $author$project$Api$InputObject$encodeString_comparison_exp)),
				_Utils_Tuple2(
				'numero_rue',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.numero_rue, $author$project$Api$InputObject$encodeInt_comparison_exp)),
				_Utils_Tuple2(
				'pays',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.pays, $author$project$Api$InputObject$encodeString_comparison_exp)),
				_Utils_Tuple2(
				'prenom',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.prenom, $author$project$Api$InputObject$encodeString_comparison_exp)),
				_Utils_Tuple2(
				'rue',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.rue, $author$project$Api$InputObject$encodeString_comparison_exp)),
				_Utils_Tuple2(
				'ville',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.ville, $author$project$Api$InputObject$encodeString_comparison_exp))
			]));
};
var $author$project$Api$InputObject$encodeProfession_bool_exp = function (_v0) {
	var input = _v0.a;
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				...
				A2(
					...
					input.and_,
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$list(
						$dillonkearns$elm_graphql$Graphql$Internal$Encode$maybe($author$project$Api$InputObject$encodeProfession_bool_exp)))),
				_Utils_Tuple2(
				'_not',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.not_, $author$project$Api$InputObject$encodeProfession_bool_exp)),
				_Utils_Tuple2(
				'_or',
				A2(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$optional,
				...
				_Utils_Tuple2(
				'profession',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.profession, $author$project$Api$InputObject$encodeString_comparison_exp))
			]));
};
...
var $author$project$Api$Enum$Order_by$toString = function (_enum) {
	switch (_enum.$) {
		case 'Asc':
			return 'asc';
...
var $author$project$Page$Patients$emptyForm = {code_postal: '', date_de_naissance: '', genre: '', moyen_de_decouverte: '', nom: '', numero_de_rue: '', pays: '', prenom: '', rue: '', ville: ''};
var $author$project$Page$Patients$GetPatientsResponse = function (a) {
	return {$: 'GetPatientsResponse', a: a};
};
var $author$project$Page$Patients$Patient = function (prenom) {
	return function (nom) {
...
var $author$project$Api$storeCredFromAuth = function (info) {
	var _v0 = info.idToken;
	if (_v0.$ === 'Just') {
		var idToken = _v0.a;
		return $author$project$Api$storeCred(
			$author$project$Api$Cred(idToken));
	} else {
		return $elm$core$Platform$Cmd$none;
	}
};
var $author$project$Page$Calendar$toSession = function (_v0) {
	var rawModel = _v0.a;
	return rawModel.session;
};
var $author$project$Page$Patients$toSession = function (_v0) {
	var rawModel = _v0.a;
	return rawModel.session;
};
var $author$project$Main$toSession = function (page) {
	switch (page.$) {
		...
		case 'Calendar':
			var calendar = page.a;
			return $author$project$Page$Calendar$toSession(calendar);
		default:
			var patients = page.a;
			return $author$project$Page$Patients$toSession(patients);
	}
};
...
var $author$project$Main$changeRouteTo = F2(
	function (maybeRoute, model) {
		...
		if (cred.$ === 'Just') {
			var _v1 = A2($elm$core$Debug$log, 'maybeRoute (l112)', maybeRoute);
			if (_v1.$ === 'Nothing') {
				return _Utils_Tuple2(
			...
			if ((maybeRoute.$ === 'Just') && (maybeRoute.a.$ === 'Root')) {
				var maybeCallbackInfo = maybeRoute.a.a;
				if (maybeCallbackInfo.$ === 'Just') {
					var callbackInfo = maybeCallbackInfo.a;
					return _Utils_Tuple2(
						$author$project$Main$Redirect(session),
						$author$project$Api$storeCredFromAuth(callbackInfo));
				} else {
					return _Utils_Tuple2(
						$author$project$Main$Redirect(session),
...
var $author$project$Session$fromCred = F2(
	function (key, maybeCred) {
		if (maybeCred.$ === 'Just') {
			var credVal = maybeCred.a;
			return A2($author$project$Session$LoggedIn, key, credVal);
		} else {
...
var $author$project$Route$Patients = {$: 'Patients'};
var $author$project$Route$Root = function (a) {
	return {$: 'Root', a: a};
};
var $kkpoon$elm_auth0_urlparser$Auth0$UrlParser$Auth0CallbackInfo = F5(
	function (accessToken, idToken, expiresIn, tokenType, state) {
		return {accessToken: accessToken, expiresIn: expiresIn, idToken: idToken, state: state, tokenType: tokenType};
	});
var $author$project$Route$accessTokenUrlParser = function (maybeString) {
	var fragment = A2($elm$core$Maybe$withDefault, '', maybeString);
	return A2(
		$elm$core$String$startsWith,
		'access_token',
		A2($elm$core$Debug$log, 'fragment', fragment)) ? $elm$core$Maybe$Just(
		A3(
			$elm$core$List$foldr,
			F2(
				function (item, info) {
							...
							switch (item.a) {
								...
								case 'id_token':
									...
									return _Utils_update(
										info,
										{
											idToken: $elm$core$Maybe$Just(token)
										});
								case 'expires_in':
									var _v3 = item.b;
									var sec = _v3.a;
									return _Utils_update(
										info,
										{
											expiresIn: $elm$core$String$toInt(sec)
										});
								case 'token_type':
									var _v4 = item.b;
									var tokenType = _v4.a;
									return _Utils_update(
										info,
										{
											tokenType: $elm$core$Maybe$Just(tokenType)
										});
								case 'state':
									var _v5 = item.b;
									var state = _v5.a;
			...
			A5($kkpoon$elm_auth0_urlparser$Auth0$UrlParser$Auth0CallbackInfo, '', $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing),
			A2(
				$elm$core$List$map,
				$elm$core$String$split('='),
				A2($elm$core$String$split, '&', fragment)))) : $elm$core$Maybe$Nothing;
};
...
var $author$project$Route$parser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			$elm$url$Url$Parser$fragment($author$project$Route$accessTokenUrlParser)),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Route$Calendar,
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Route$Patients,
			$elm$url$Url$Parser$s('patients'))
		]));
...
var $author$project$Main$init = F3(
	function (maybeCred, url, navKey) {
		var session = A2($author$project$Session$fromCred, navKey, maybeCred);
		return A2(
...
var $author$project$Api$credChanges = function (toMsg) {
	return $author$project$Api$onStoreChange(
		function (value) {
			return toMsg(
				$author$project$Api$decodeFromChange(value));
		});
};
var $author$project$Session$changes = F2(
	function (toMsg, key) {
		return $author$project$Api$credChanges(
			function (maybeCred) {
				return toMsg(
...
var $author$project$Page$Patients$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
...
var $author$project$Api$Enum$Agenda_update_column$toString = function (_enum) {
	switch (_enum.$) {
		case 'Date':
			return 'date';
		case 'Heure':
...
var $author$project$Api$InputObject$encodeAgenda_on_conflict = function (_v0) {
	var input = _v0.a;
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				...
				'constraint',
				$elm$core$Maybe$Just(
					A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$enum, $author$project$Api$Enum$Agenda_constraint$toString, input.constraint))),
				_Utils_Tuple2(
				'update_columns',
				$elm$core$Maybe$Just(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$list(
						$dillonkearns$elm_graphql$Graphql$Internal$Encode$enum($author$project$Api$Enum$Agenda_update_column$toString))(input.update_columns))),
				_Utils_Tuple2(
				'where',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.where_, $author$project$Api$InputObject$encodeAgenda_bool_exp))
			]));
};
var $author$project$Api$Enum$Consultation_constraint$toString = function (_enum) {
	switch (_enum.$) {
		case 'Consultation_indice_anxiete_key':
			return 'Consultation_indice_anxiete_key';
		case 'Consultation_mots_cles_key':
			return 'Consultation_mots_cles_key';
		default:
			return 'Consultation_pkey';
	}
};
var $author$project$Api$Enum$Consultation_update_column$toString = function (_enum) {
	switch (_enum.$) {
		case 'Id_agenda':
			return 'id_agenda';
		case 'Id_patient':
			return 'id_patient';
		case 'Indice_anxiete':
			return 'indice_anxiete';
		case 'Mode_de_reglement':
			return 'mode_de_reglement';
		case 'Mots_cles':
			return 'mots_cles';
		default:
			return 'prix';
...
var $author$project$Api$InputObject$encodeConsultation_on_conflict = function (_v0) {
	var input = _v0.a;
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				...
				'constraint',
				$elm$core$Maybe$Just(
					A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$enum, $author$project$Api$Enum$Consultation_constraint$toString, input.constraint))),
				_Utils_Tuple2(
				'update_columns',
				$elm$core$Maybe$Just(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$list(
						$dillonkearns$elm_graphql$Graphql$Internal$Encode$enum($author$project$Api$Enum$Consultation_update_column$toString))(input.update_columns))),
				_Utils_Tuple2(
				'where',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.where_, $author$project$Api$InputObject$encodeConsultation_bool_exp))
			]));
};
var $author$project$Api$Enum$Patient_Profession_constraint$toString = function (_enum) {
	return 'Patient_Profession_pkey';
};
var $author$project$Api$Enum$Patient_Profession_update_column$toString = function (_enum) {
	switch (_enum.$) {
		case 'Date_de_debut':
...
var $author$project$Api$InputObject$encodePatient_Profession_on_conflict = function (_v0) {
	var input = _v0.a;
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				...
				'constraint',
				$elm$core$Maybe$Just(
					A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$enum, $author$project$Api$Enum$Patient_Profession_constraint$toString, input.constraint))),
				_Utils_Tuple2(
				'update_columns',
				$elm$core$Maybe$Just(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$list(
						$dillonkearns$elm_graphql$Graphql$Internal$Encode$enum($author$project$Api$Enum$Patient_Profession_update_column$toString))(input.update_columns))),
				_Utils_Tuple2(
				'where',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.where_, $author$project$Api$InputObject$encodePatient_Profession_bool_exp))
			]));
};
var $author$project$Api$Enum$Patient_constraint$toString = function (_enum) {
	if (_enum.$ === 'Patient_id_key') {
		return 'Patient_id_key';
	} else {
		return 'Patient_pkey';
	}
};
var $author$project$Api$Enum$Patient_update_column$toString = function (_enum) {
	switch (_enum.$) {
		case 'Code_postal':
			return 'code_postal';
		case 'Date_de_naissance':
...
var $author$project$Api$InputObject$encodePatient_on_conflict = function (_v0) {
	var input = _v0.a;
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				...
				'constraint',
				$elm$core$Maybe$Just(
					A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$enum, $author$project$Api$Enum$Patient_constraint$toString, input.constraint))),
				_Utils_Tuple2(
				'update_columns',
				$elm$core$Maybe$Just(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$list(
						$dillonkearns$elm_graphql$Graphql$Internal$Encode$enum($author$project$Api$Enum$Patient_update_column$toString))(input.update_columns))),
				_Utils_Tuple2(
				'where',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.where_, $author$project$Api$InputObject$encodePatient_bool_exp))
			]));
};
var $author$project$Api$Enum$Profession_constraint$toString = function (_enum) {
	if (_enum.$ === 'Profession_id_key') {
		return 'Profession_id_key';
	} else {
		return 'Profession_pkey';
	}
};
var $author$project$Api$Enum$Profession_update_column$toString = function (_enum) {
	if (_enum.$ === 'Id_profession') {
		return 'id_profession';
	} else {
		return 'profession';
	}
};
var $author$project$Api$InputObject$encodeProfession_on_conflict = function (_v0) {
	var input = _v0.a;
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				...
				'constraint',
				$elm$core$Maybe$Just(
					A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$enum, $author$project$Api$Enum$Profession_constraint$toString, input.constraint))),
				_Utils_Tuple2(
				'update_columns',
				$elm$core$Maybe$Just(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$list(
						$dillonkearns$elm_graphql$Graphql$Internal$Encode$enum($author$project$Api$Enum$Profession_update_column$toString))(input.update_columns))),
				_Utils_Tuple2(
				'where',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.where_, $author$project$Api$InputObject$encodeProfession_bool_exp))
			]));
};
var $author$project$Api$InputObject$encodeAgenda_insert_input = function (_v9) {
	var input = _v9.a;
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'Consultations',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.consultations, $author$project$Api$InputObject$encodeConsultation_arr_rel_insert_input)),
				_Utils_Tuple2(
				'date',
				A2(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$optional,
				...
				_Utils_Tuple2(
				'id_agenda',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.id_agenda, $dillonkearns$elm_graphql$Graphql$Internal$Encode$int))
			]));
};
var $author$project$Api$InputObject$encodeAgenda_obj_rel_insert_input = function (_v8) {
	var input = _v8.a;
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				...
				'data',
				$elm$core$Maybe$Just(
					$author$project$Api$InputObject$encodeAgenda_insert_input(input.data))),
				_Utils_Tuple2(
				'on_conflict',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.on_conflict, $author$project$Api$InputObject$encodeAgenda_on_conflict))
			]));
};
var $author$project$Api$InputObject$encodeConsultation_arr_rel_insert_input = function (_v7) {
	var input = _v7.a;
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				...
				'data',
				$elm$core$Maybe$Just(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$list($author$project$Api$InputObject$encodeConsultation_insert_input)(input.data))),
				_Utils_Tuple2(
				'on_conflict',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.on_conflict, $author$project$Api$InputObject$encodeConsultation_on_conflict))
			]));
};
var $author$project$Api$InputObject$encodeConsultation_insert_input = function (_v6) {
	var input = _v6.a;
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'Agenda',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.agenda, $author$project$Api$InputObject$encodeAgenda_obj_rel_insert_input)),
				_Utils_Tuple2(
				'Patient',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.patient, $author$project$Api$InputObject$encodePatient_obj_rel_insert_input)),
				_Utils_Tuple2(
				'id_agenda',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.id_agenda, $dillonkearns$elm_graphql$Graphql$Internal$Encode$int)),
				_Utils_Tuple2(
				'id_patient',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.id_patient, $dillonkearns$elm_graphql$Graphql$Internal$Encode$int)),
				_Utils_Tuple2(
				'indice_anxiete',
				A2(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$optional,
					input.indice_anxiete,
					A2(
						$author$project$Api$Scalar$unwrapEncoder,
						function ($) {
							return $.codecSmallint;
				...
				_Utils_Tuple2(
				'mode_de_reglement',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.mode_de_reglement, $dillonkearns$elm_graphql$Graphql$Internal$Encode$string)),
				_Utils_Tuple2(
				'mots_cles',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.mots_cles, $dillonkearns$elm_graphql$Graphql$Internal$Encode$string)),
				_Utils_Tuple2(
				'prix',
				A2(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$optional,
...
var $author$project$Api$InputObject$encodePatient_Profession_arr_rel_insert_input = function (_v5) {
	var input = _v5.a;
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				...
				'data',
				$elm$core$Maybe$Just(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$list($author$project$Api$InputObject$encodePatient_Profession_insert_input)(input.data))),
				_Utils_Tuple2(
				'on_conflict',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.on_conflict, $author$project$Api$InputObject$encodePatient_Profession_on_conflict))
			]));
};
var $author$project$Api$InputObject$encodePatient_Profession_insert_input = function (_v4) {
	var input = _v4.a;
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'Profession',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.profession, $author$project$Api$InputObject$encodeProfession_obj_rel_insert_input)),
				_Utils_Tuple2(
				'date_de_debut',
				A2(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$optional,
				...
				_Utils_Tuple2(
				'id_profession',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.id_profession, $dillonkearns$elm_graphql$Graphql$Internal$Encode$int))
			]));
};
var $author$project$Api$InputObject$encodePatient_insert_input = function (_v3) {
	var input = _v3.a;
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'Patient_Professions',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.patient_Professions, $author$project$Api$InputObject$encodePatient_Profession_arr_rel_insert_input)),
				_Utils_Tuple2(
				'code_postal',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.code_postal, $dillonkearns$elm_graphql$Graphql$Internal$Encode$int)),
				_Utils_Tuple2(
				'date_de_naissance',
				A2(
					$dillonkearns$elm_graphql$Graphql$Internal$Encode$optional,
				...
				_Utils_Tuple2(
				'genre',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.genre, $dillonkearns$elm_graphql$Graphql$Internal$Encode$string)),
				_Utils_Tuple2(
				'id_patient',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.id_patient, $dillonkearns$elm_graphql$Graphql$Internal$Encode$int)),
				_Utils_Tuple2(
				'moyen_de_decouverte',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.moyen_de_decouverte, $dillonkearns$elm_graphql$Graphql$Internal$Encode$string)),
				_Utils_Tuple2(
				'nom',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.nom, $dillonkearns$elm_graphql$Graphql$Internal$Encode$string)),
				_Utils_Tuple2(
				'numero_rue',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.numero_rue, $dillonkearns$elm_graphql$Graphql$Internal$Encode$int)),
				_Utils_Tuple2(
				'pays',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.pays, $dillonkearns$elm_graphql$Graphql$Internal$Encode$string)),
				_Utils_Tuple2(
				'prenom',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.prenom, $dillonkearns$elm_graphql$Graphql$Internal$Encode$string)),
				_Utils_Tuple2(
				'rue',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.rue, $dillonkearns$elm_graphql$Graphql$Internal$Encode$string)),
				_Utils_Tuple2(
				'ville',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.ville, $dillonkearns$elm_graphql$Graphql$Internal$Encode$string))
			]));
};
var $author$project$Api$InputObject$encodePatient_obj_rel_insert_input = function (_v2) {
	var input = _v2.a;
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				...
				'data',
				$elm$core$Maybe$Just(
					$author$project$Api$InputObject$encodePatient_insert_input(input.data))),
				_Utils_Tuple2(
				'on_conflict',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.on_conflict, $author$project$Api$InputObject$encodePatient_on_conflict))
			]));
};
var $author$project$Api$InputObject$encodeProfession_insert_input = function (_v1) {
	var input = _v1.a;
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'profession',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.profession, $dillonkearns$elm_graphql$Graphql$Internal$Encode$string))
			]));
};
var $author$project$Api$InputObject$encodeProfession_obj_rel_insert_input = function (_v0) {
	var input = _v0.a;
	return $dillonkearns$elm_graphql$Graphql$Internal$Encode$maybeObject(
		_List_fromArray(
			[
				...
				'data',
				$elm$core$Maybe$Just(
					$author$project$Api$InputObject$encodeProfession_insert_input(input.data))),
				_Utils_Tuple2(
				'on_conflict',
				A2($dillonkearns$elm_graphql$Graphql$Internal$Encode$optional, input.on_conflict, $author$project$Api$InputObject$encodeProfession_on_conflict))
			]));
};
...
var $author$project$Page$Calendar$updateForm = F2(
...
var $author$project$Page$Calendar$update = F2(
	function (msg, model) {
		var data = function () {
...
var $author$project$Page$Patients$update = F2(
	function (msg, model) {
		var data = function () {
			var datamodel = model.a;
			return datamodel;
		...
		switch (msg.$) {
			...
			case 'EnteredPrenom':
				var text = msg.a;
				return A2(
					$author$project$Page$Patients$updateForm,
					function (form) {
						return _Utils_update(
							form,
							{prenom: text});
...
var $author$project$Page$Calendar = {$: 'Calendar'};
var $author$project$Page$Other = {$: 'Other'};
var $author$project$Page$Patients = {$: 'Patients'};
...
var $author$project$Page$Calendar$graphqlErrorToString = function (error) {
	return error.message;
};
var $author$project$Page$Calendar$errorToString = function (errorData) {
	if (errorData.$ === 'GraphqlError') {
		var graphqlErrors = errorData.b;
		return A2(
			$elm$core$String$join,
			'\n',
			A2($elm$core$List$map, $author$project$Page$Calendar$graphqlErrorToString, graphqlErrors));
	} else {
		...
		switch (httpError.$) {
			...
			case 'BadStatus':
				...
				var error = httpError.b;
				return error;
			default:
				var jsonDecodeError = httpError.a;
				return 'There was a bad payload';
		}
	}
};
...
var $author$project$Page$Calendar$tableField = function (data) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
...
var $author$project$Page$Calendar$textInput = F4(
...
var $author$project$Page$Patients$graphqlErrorToString = function (error) {
	return error.message;
};
var $author$project$Page$Patients$errorToString = function (errorData) {
	if (errorData.$ === 'GraphqlError') {
		var graphqlErrors = errorData.b;
		return A2(
			$elm$core$String$join,
			'\n',
			A2($elm$core$List$map, $author$project$Page$Patients$graphqlErrorToString, graphqlErrors));
	} else {
		var httpError = errorData.a;
		switch (httpError.$) {
			case 'BadUrl':
...
var $author$project$Page$Patients$EnteredDate_de_naissance = function (a) {
	return {$: 'EnteredDate_de_naissance', a: a};
};
var $author$project$Page$Patients$EnteredGenre = function (a) {
	return {$: 'EnteredGenre', a: a};
};
var $author$project$Page$Patients$EnteredMoyen_de_decouverte = function (a) {
	return {$: 'EnteredMoyen_de_decouverte', a: a};
};
var $author$project$Page$Patients$EnteredNom = function (a) {
	return {$: 'EnteredNom', a: a};
};
var $author$project$Page$Patients$EnteredNumero_de_rue = function (a) {
	return {$: 'EnteredNumero_de_rue', a: a};
};
var $author$project$Page$Patients$EnteredPays = function (a) {
	return {$: 'EnteredPays', a: a};
};
var $author$project$Page$Patients$EnteredPrenom = function (a) {
	return {$: 'EnteredPrenom', a: a};
};
var $author$project$Page$Patients$EnteredRue = function (a) {
	return {$: 'EnteredRue', a: a};
};
var $author$project$Page$Patients$EnteredVille = function (a) {
	return {$: 'EnteredVille', a: a};
};
var $author$project$Page$Patients$DeletePatient = function (a) {
	return {$: 'DeletePatient', a: a};
};
var $author$project$Page$Patients$tableField = function (data) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
...
var $author$project$Page$Patients$patientTable = function (response) {
	return A2(
		$mdgriffith$elm_ui$Element$table,
		_List_fromArray(
			[
			...
			]),
		{
			columns: _List_fromArray(
				[
					{
					header: $author$project$Page$Patients$tableField('Prénom'),
					view: function (patient) {
						return $author$project$Page$Patients$tableField(patient.prenom);
					},
					width: $mdgriffith$elm_ui$Element$fill
				},
					{
					header: $author$project$Page$Patients$tableField('Nom'),
					view: function (patient) {
						return $author$project$Page$Patients$tableField(patient.nom);
					},
					width: $mdgriffith$elm_ui$Element$fill
				},
					{
					header: $author$project$Page$Patients$tableField('Numéro de rue'),
					view: function (patient) {
						return $author$project$Page$Patients$tableField(
							$elm$core$String$fromInt(patient.numero_rue));
					},
					width: $mdgriffith$elm_ui$Element$fill
				},
					{
					header: $author$project$Page$Patients$tableField('Rue'),
					view: function (patient) {
						return $author$project$Page$Patients$tableField(patient.rue);
					},
					width: $mdgriffith$elm_ui$Element$fill
				},
					{
					header: $author$project$Page$Patients$tableField('Code postal'),
					view: function (patient) {
						return $author$project$Page$Patients$tableField(
					...
					{
					header: $author$project$Page$Patients$tableField('Ville'),
					view: function (patient) {
						return $author$project$Page$Patients$tableField(patient.ville);
					},
					width: $mdgriffith$elm_ui$Element$fill
				},
					{
					header: $author$project$Page$Patients$tableField('Pays'),
					view: function (patient) {
						return $author$project$Page$Patients$tableField(patient.pays);
					},
					width: $mdgriffith$elm_ui$Element$fill
				},
					{
					header: $author$project$Page$Patients$tableField('Date de naissance'),
					view: function (patient) {
						return $author$project$Page$Patients$tableField(
							function () {
					...
					{
					header: $author$project$Page$Patients$tableField('Genre'),
					view: function (patient) {
						return $author$project$Page$Patients$tableField(patient.genre);
					},
					width: $mdgriffith$elm_ui$Element$fill
				},
					{
					header: $author$project$Page$Patients$tableField('Moyen de découverte'),
					view: function (patient) {
						return $author$project$Page$Patients$tableField(patient.moyen_de_decouverte);
					},
					width: $mdgriffith$elm_ui$Element$fill
				},
					{
					header: $author$project$Page$Patients$tableField('Supprimer patient'),
					view: function (patient) {
						return A2(
							$mdgriffith$elm_ui$Element$Input$button,
							_List_fromArray(
...
var $author$project$Page$Patients$textInput = F4(
	function (msg, formtext, placeholder, label) {
		return A2(
			$mdgriffith$elm_ui$Element$Input$text,
			_List_fromArray(
...
var $author$project$Page$Patients$successView = F3(
	function (response, form, addPatientData) {
		var error = function () {
			if (addPatientData.$ === 'Failure') {
				var graphqlError = addPatientData.a;
				return $mdgriffith$elm_ui$Element$text(
					$author$project$Page$Patients$errorToString(graphqlError));
			} else {
				return $mdgriffith$elm_ui$Element$text('');
			}
		}();
		...
		body: _List_fromArray(
			[
				...
				switch (_v0.$) {
					...
					default:
						var error = _v0.a;
						return $author$project$Page$Patients$failureView(error);
				}
			}()
			]),
		title: 'Patients'
...
var $author$project$Main$view = function (model) {
	var cred = $author$project$Session$cred(
		$author$project$Main$toSession(model));
	var viewPage = F3(
		function (page, toMsg, config) {
			var _v1 = A3($author$project$Page$view, cred, page, config);
			var title = _v1.title;
			var body = _v1.body;
			return {
				body: A2(
	...
	switch (model.$) {
		...
		case 'Calendar':
			...
			return A3(
				viewPage,
				$author$project$Page$Calendar,
				$author$project$Main$GotCalendarMsg,
				$author$project$Page$Calendar$view(calendar));
		default:
			var patients = model.a;
			return A3(
				viewPage,
				$author$project$Page$Patients,
				$author$project$Main$GotPatientsMsg,
				$author$project$Page$Patients$view(patients));
	}
};
var $author$project$Main$main = $author$project$Api$application(
