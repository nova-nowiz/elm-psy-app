...
module Api.Enum.Consultation_update_column exposing (..)
...
-}
type Consultation_update_column
    = Id_agenda
    | Id_patient
    | Indice_anxiete
    | Mode_de_reglement
...
list : List Consultation_update_column
list =
    [ Id_agenda, Id_patient, Indice_anxiete, Mode_de_reglement, Mots_cles, Prix ]


decoder : Decoder Consultation_update_column
decoder =
    Decode.string
        |> Decode.andThen
            (\string ->
                case string of
                    ...
                    _ ->
                        Decode.fail ("Invalid Consultation_update_column type, " ++ string ++ " try re-running the @dillonkearns/elm-graphql CLI ")
            )


{-| Convert from the union type representating the Enum to a string that the GraphQL server will recognize.
-}
toString : Consultation_update_column -> String
toString enum =
    case enum of
        Id_agenda ->
            "id_agenda"
...
-}
fromString : String -> Maybe Consultation_update_column
